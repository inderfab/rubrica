...
BASE = "https://127.0.0.1:8443/anna/testbook"
...
def main():
    with httpx.Client(auth=("anna", ""), verify=False) as client:  # selbstsigniertes Zertifikat
    ...
    print("  Server: Anna-Mac-Studio.local, Port: 8443, SSL: an, Pfad: /anna/testbook/, kein Passwort")
