...
cp mail_intake.py           "$APP/Contents/Resources/"
cp mail_erinnerung.py       "$APP/Contents/Resources/"
cp kontakte_app_intake.py   "$APP/Contents/Resources/"
cp scripts/radicale_set_password.py "$APP/Contents/Resources/"
cp scripts/radicale_migrate_user.py "$APP/Contents/Resources/"
cp scripts/migrate-radicale-user.sh "$APP/Contents/Resources/"
cp scripts/reset-radicale-clean.sh  "$APP/Contents/Resources/"
...
<dict>
  ...
  <string>ch.rubrica.server</string>
