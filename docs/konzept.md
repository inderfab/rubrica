...
erzeugt wie bisher Vorschlaege in die Review-Queue. Umsetzungsplan Rubrica-seitig:
  ...
  - **Kontext zur Postfach-Struktur (Nutzer-Erklaerung 2026-07-13):** Muster nutzt ein gemeinsames Mailkonto
    `projekte@muster.ch` mit je einem Postfach/Unterordner pro Projekt (z.B. "200 Keller Diamant") - alle
    Mails darin gehoeren eindeutig zu diesem einen Projekt. Mitarbeiter verschieben projektbezogene Mails aus
    ihrem persoenlichen Postfach (z.B. `fi@muster.ch`) dorthin, sobald ein Projekt zugewiesen ist. Postfach- und
